...
import {
  getKioskCaseStudy,
  getAdjacentKioskCaseStudies,
  kioskCaseStudyOrder,
  type KioskCaseStudySlug,
} from "@/lib/case-studies";

type Params = { slug: string };

export function generateStaticParams(): Params[] {
  return kioskCaseStudyOrder.map((slug) => ({ slug }));
}
...
export default async function CaseStudyPage({
  ...
  const { prev, next } = getAdjacentKioskCaseStudies(
    slug as KioskCaseStudySlug,
  );
