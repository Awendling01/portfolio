  ...
  return (
    <>
      ...
      <section className="py-20">
        <Container>
          <CtaCard
            heading="Want to talk through any of this on a call?"
            body="Happy to walk through the DDD architecture, the Vue migration approach, or any of the integration surfaces in more detail."
          />
        </Container>
      </section>
    </>
